...
def my_link():
    ...
    try:
      ...
      return render_template('index.html', ciphertext="ERROR! PLEASE TRY AGAIN! (MAKE SURE TO SELECT ALL INPUTS)", plaintext="N/A")
...
def my_link_new():
  try:
    ...
    return render_template('index.html', publicKey="ERROR! PLEASE TRY AGAIN! (MAKE SURE INPUT IS UNDER 22 CHARACTERS)", privateKey="N/A", encMessage="", decMessage="")
